...
const ListeDeclarationHorsDelaisScreen = ({ navigation, route }) => {
  ...
  const goToDeclarationWizard = data => {
    navigate('DeclarationWizard', { data: JSON.stringify(data) })
  }
      ...
      <View style={tailwind('flex-1 p-4')}>
        ...
        {!fetchDeclarationsLoading && !fetchDeclarationsError && (
          <FlatList
            ...
            ListEmptyComponent={() => (
              <EmptyView
                message="Vous n'avez aucune déclaration hors délais"
...
export default ListeDeclarationHorsDelaisScreen
