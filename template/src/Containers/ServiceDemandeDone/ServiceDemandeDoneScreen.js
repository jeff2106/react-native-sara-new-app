...
const ServiceDemandeDone = ({ navigation, route }) => {
        ...
        <View style={tailwind('flex-1 p-4')}>
          ...
          >
            <View style={tailwind('items-center justify-center mt-5')}>
              ...
              >
                Votre demande a été enregistrée avec succès. Vous recevrez des
                notifications relatives l'évolution de votre demande.
              </Text>
...
export default ServiceDemandeDone
