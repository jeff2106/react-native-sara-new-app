...
import { DateInput, DocumentSelect, TextInput } from '@/Components'
...
import CalculeInput from '@/Components/CalculeInput'
import PickerInputDynamic from '@/Components/PickerInputDynamic'

const DynamicForm = ({ onDataChange, fields = [], disabled }) => {
