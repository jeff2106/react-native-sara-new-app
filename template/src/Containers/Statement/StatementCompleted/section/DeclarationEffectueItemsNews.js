...
const DeclarationEffectueItemNews = ({
  data,
  onPress,
  btnText,
  btn_Status,
  ...
  return (
    ...
    >
      ...
      <View style={tailwind('p-4 bg-blueGray')}>
        ...
        <View style={tailwind('flex-row  mb-2 w-full justify-between')}>
          <Text
            style={[
              tailwind('font-bold text-sm text-gray-900'),
              { fontFamily: 'Gilroy-Bold' },
          ...
          <View style={tailwind('flex-row  mb-2 items-center')}>
            {data?.r_statut_formulaire == 2 && (
        ...
        {isPayable && data?.r_statut_formulaire === 3 && (
          <Button
            disabled={false}
            onPress={onPress}
        ...
        {isPayable && data?.r_statut_formulaire === 1 && (
          <Button
            disabled={true}
            onPress={onPress}
            style={tailwind('mt-5 ml-5 mr-5 ')}
        ...
        {isPayable && data?.r_statut_formulaire == 2 && (
          <Button
            disabled={false}
            onPress={onPress}
            style={tailwind('mt-5 ml-5 mr-5 ')}
...
DeclarationEffectueItemNews.propTypes = {
  data: PropTypes.any,
  btnText: PropTypes.string,
  btn_Status: PropTypes.number,
}

DeclarationEffectueItemNews.defaultProps = {
  data: {},
  btnText: 'Consulter la déclaration',
  btn_Status: 0,
}

export default DeclarationEffectueItemNews
