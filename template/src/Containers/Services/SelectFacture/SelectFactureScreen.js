...
const SelectFacture = ({ navigation, route }) => {
  const dispatch = useDispatch()

  const factures = [
    {
      id: 1,
      libelle: 'REF_1234_5678',
      amount: 50367,
    },
    {
      id: 2,
      libelle: 'REF_9876_1234',
      amount: 35012,
    },
  ]
  ...
  const [form, setForm] = useState(data.service.form)
            ...
            >
                  ...
                  >
                    <View style={tailwind('flex-1 flex-row items-center')}>
                      <Text
                        style={[
                          tailwind(
                            'flex-1 font-bold text-gray-700 text-sm ml-2',
                          ),
                          { fontFamily: 'Gilroy-Bold' },
                        ]}
                      >
              ...
              {factures.map((facture, index) => (
                ...
                >
                  ...
                  {selectedFacture && selectedFacture.id === facture.id && (
                    <View style={tailwind('flex-row items-center')}>
                      <View
                        style={[
                          tailwind('rounded-full bg-gray-500 bg-opacity-25'),
              ...
              <View style={tailwind('mt-5 mb-5 flex-row')}>
                ...
                <Button
                  disabled={!selectedFacture || !selectedPaymentMethod}
                  onPress={goToPaiementResume}
                >
                  Payer maintenant
                </Button>
              </View>
