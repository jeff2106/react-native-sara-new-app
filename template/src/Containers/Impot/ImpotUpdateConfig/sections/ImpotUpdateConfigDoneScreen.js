...
const ImpotUpdateConfigDoneScreen = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      >
        Votre configuration a bien été mise à jour.
      </Text>
...
ImpotUpdateConfigDoneScreen.propTypes = {}

ImpotUpdateConfigDoneScreen.defaultProps = {}

export default ImpotUpdateConfigDoneScreen
