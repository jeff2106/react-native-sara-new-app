...
import {
  ...
  ButtonPaiement,
  SearchTextInput,
} from '@/Containers/Statement/TransactionOutOfTime/Components'
...
const FilterTransacOutOfTime = ({ navigation, onChange, onChangeText }) => {
...
export default FilterTransacOutOfTime
