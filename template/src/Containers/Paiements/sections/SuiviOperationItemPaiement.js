...
const SuiviOperationItemPaiement = ({ onPress, title, value, icon, color }) => {
  return (
...
SuiviOperationItemPaiement.propTypes = {}

SuiviOperationItemPaiement.defaultProps = {}

export default SuiviOperationItemPaiement
